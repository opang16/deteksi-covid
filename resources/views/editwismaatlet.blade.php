...
<form action="/wisma-atlet/{{ $id->id }}" method="POST">
    ...
    <div class="form-group">
      ...
      @enderror" id="name" placeholder="Masukan Nama Wisma Atlet" name="name" value="{{ $id->name }}">
      @error('name')
    ...
    <div class="form-group">
        ...
        @enderror" id="alamat" placeholder="Masukan Alamat Wisma Atlet" name="alamat" value="{{ $id->alamat  }}">
      @error('alamat')
      <div class="invalid-feedback"> {{ $message }}</div>
      @enderror
      </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="email" placeholder="Masukan Email Wisma Atlet" name="email" value="{{ $id->email  }}">
    </div>
